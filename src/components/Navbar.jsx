...
const Navbar = () => {
  ...
  return (
    <div
      className={`absolute lg:top-14 top-32 w-full py-10 z-50  ${
    ...
    >
      <div className="mx-auto container flex items-center justify-between flex-wrap lg:flex-nowrap px-9 lg:px-10">
        ...
        <div className="text-gray-500 order-3 w-full lg:w-auto lg:order-2">
          ...
          >
            <ul className="flex justify-between lg:space-x-[30px] 2xl:space-x-9 items-start   lg:flex-row flex-col ">
              <li
                className="text-[#424242]
                  lg:px-3 font-secondary text-base  lg:p-0 cursor-pointer border-y border-[#F2F4F7] w-full px-9 py-4 lg:w-auto"
              >
                Home
              </li>
              <li
