...
const TestimonialItem = ({ data, handleClick }) => {
  return (
    <div className="flex items-center w-full">
      <div className="flex justify-end items-center relative w-full">
        <div className="absolute top-0 left-0 w-[700px] h-[430px] mt-10">
          <Image src={data.image} alt={data.name} width={545} height={427} />
        </div>
        <div className="bg-[#EDF9FF] justify-end pt-10 w-[745px] h-[477px] flex rounded-xl pr-[140px]">
          <div className="mr-10">
