...
const Hero = () => {
  return (
    <div className="flex flex-col container mx-auto pl-9 pr-8">
      <div className=" w-full overflow-hidden flex justify-between items-center mt-[170px] ">
        <div className="">
          <div className=" flex items-end justify-between ">
            <h1 className=" font-primary font-bold text-[82px] leading-[100%] lg:w-[780px] mt-[63px] bannerTitle">
